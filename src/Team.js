        ...
        return (
            <div className="container-fluid" id="parent_">
                ...
                <div className="row heading">
                    <div className="col">
                        <div className="designation">Dean Student Affairs</div>
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/pj.JPEG') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                                    <div className="name">Dr. Perminderjit Singh</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/walia.JPEG') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                                    <div className="name">Dr. R.S. Walia</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row heading">
                    <div className="col">
                        <div className="designation">Organizing Secretaries</div>
                        <div className="row">
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/raminder.JPEG') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                                        <div className="name">Dr. Raminder Kaur</div>
                                    </div>
                                </div>
                            </div>
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/batish.PNG') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                                        <div className="name">Dr. Sanjay Batish</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Akhilesh.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Harsh.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="row">
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/MayankGoyal.jpg') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                            ...
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/Shivam.jpg') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                        ...
                        <div className="row">
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/Shubam.jpg') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                            ...
                            <div className="Team-card"
                                 style={{backgroundImage: 'url(' + require('./team/Isha.jpg') + ')'}}>
                                <div className="card_inner">
                                    <div className="pad"></div>
                                    <div className="card_content_top"></div>
                                    <div className="card_content_bottom">
                ...
                <div className="row">
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Aseem.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Ananya.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row">
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Devansh.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Shubanshu.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="Team-card" style={{backgroundImage: 'url(' + require('./team/Raghav.jpg') + ')'}}>
                        <div className="card_inner">
                            ...
                            <div className="card_content_bottom">
                                ...
                                <div className="email">raghavarora.beaero15@pec.edu.in</div>
                ...
                <div className="row">
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Himansh.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Gurjot.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Snigdha.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Gautam.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Ketan.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Gobind.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Akanksha.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Pratik.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Sanpreet.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                    ...
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/Vaibhav.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
                ...
                <div className="row heading">
                    <div className="col">
                        ...
                        <div className="Team-card"
                             style={{backgroundImage: 'url(' + require('./team/MayankKaura.jpg') + ')'}}>
                            <div className="card_inner">
                                <div className="pad"></div>
                                <div className="card_content_top"></div>
                                <div className="card_content_bottom">
